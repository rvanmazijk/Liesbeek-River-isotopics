...
```{r}
source(here::here("analyses/04_mass-balance.R"))
```
...
\begin{align}
    u_{p_E} 
    &= \sqrt{
        \left( u_E \frac{E_{rain} - E_{streamflow}}
                        {\left( E_{rain} - E_{baseflow} \right)^2} \right)^2 +
        \left( u_E \frac{E_{streamflow} - E_{baseflow}}
                        {\left( E_{rain} - E_{baseflow} \right)^2} \right)^2 +
        \left( u_E \frac{-1}
                        {E_{rain} - E_{baseflow}} \right)^2
    } \\
    &= \sqrt{
        u_E^2 
        \left( \left( \frac{E_{rain} - E_{streamflow}}
                           {\left( E_{rain} - E_{baseflow} \right)^2} \right)^2 +
        \left( \frac{E_{streamflow} - E_{baseflow}}
                    {\left( E_{rain} - E_{baseflow} \right)^2} \right)^2 +
        \left( \frac{-1}
                    {E_{rain} - E_{baseflow}} \right)^2 \right)
    } \\
    &= \sqrt{
        u_E^2 
        \left(\left(\frac{\left( 1 - p_E \right)}
                         {\left( E_{rain} - E_{baseflow} \right)} \right)^2 +
              \left(\frac{p_E}
                         {\left( E_{rain} - E_{baseflow} \right)} \right)^2 +
              \frac{1}
                   {\left( E_{rain} - E_{baseflow} \right)^2} \right)
    } \\
    &= \sqrt{
        u_E^2 
        \left( \frac{\left( 1 - p_E \right)^2}
    ...
    &= \sqrt{
        u_E^2 \frac{\left( 1 - p_E \right)^2 + p_E^2 + 1}
                   {\left( E_{rain} - E_{baseflow} \right)^2}
    } \\
    &= u_E \frac{\left( 1 - p_E \right) + p_E + 1}
                {E_{rain} - E_{baseflow}
    } \\
\end{align}
