...
Knowing Equations \ref{1.1}--\ref{1.3}, applying them to Equation \ref{2.1} Genereux got
...
With this approach, I get $p_{\delta^{18}O} = `r p$d18O` \pm `r u_p_d18O_Genereux`$ and $p_{\delta^{2}H} = `r p$d2H` \pm `r u_p_d2H_Genereux`$, such that following Equation \ref{2.3} $p = `r p_rain_Genereux` \pm `r u_p_rain_Genereux`$.

**Problem: $u_p$ from Equation \ref{2.2} $\ne$ that from Genereux**
